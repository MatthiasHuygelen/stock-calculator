      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white rounded-xl shadow-lg p-6 mb-6">
          <div className="flex items-center gap-2 mb-6">
            ...
            <h1 className="text-2xl font-bold text-gray-800">ETF TCO Calculator</h1>
          </div>

          <div className="grid md:grid-cols-2 gap-6">
            <div className="space-y-4">
              <h2 className="text-lg font-semibold text-gray-700">Investment Parameters</h2>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gray-50 rounded-lg p-6 space-y-4">
                <div className="bg-indigo-50 rounded-lg p-4 mb-4">
                  <h3 className="text-sm font-medium text-indigo-800 mb-2">Investment Summary</h3>
                ...
                <div>
                  <h3 className="text-sm font-medium text-gray-500">Expense Ratio Cost</h3>
                ...
                <div>
                  <h3 className="text-sm font-medium text-gray-500">Trading Costs</h3>
                  <p className="mt-1 text-xl font-semibold text-gray-900">
                ...
                <div>
                  <h3 className="text-sm font-medium text-gray-500">Dividend Taxes</h3>
                  <p className="mt-1 text-xl font-semibold text-gray-900">
                ...
                <div>
                  <h3 className="text-sm font-medium text-gray-500">Annualized TCO</h3>
                  <p className="mt-1 text-2xl font-bold text-indigo-600">
                ...
                <div className="pt-4 border-t border-gray-200">
                  <h3 className="text-sm font-medium text-gray-500">Total Returns (Before Costs)</h3>
                ...
                <div>
                  <h3 className="text-sm font-medium text-gray-500">Net Returns (After Costs)</h3>
                  <p className="mt-1 text-2xl font-bold text-green-600">
              ...
              <div className="bg-blue-50 rounded-lg p-4">
                <h3 className="text-sm font-medium text-blue-800 mb-2">About TCO Calculation</h3>
